...
gnome-terminal -x /home/loi/Vehicle_Motion_Playground/02_RunDemo/low-carla.sh
echo "wait for 10 seconds"
sleep 10s
gnome-terminal --tab --title="roscore" --command="roscore"
sleep 2s
gnome-terminal --tab --title="bridge" --command="python3 /home/loi/Vehicle_Motion_Playground/03_VMEnv/02_ros-bridge/src/ros-bridge/carla_ros_bridge/src/carla_ros_bridge/bridge.py"
sleep 3s
gnome-terminal --tab --title="application" --command="python3 /home/loi/Vehicle_Motion_Playground/03_VMEnv/03_framework/client_side/main.py"
