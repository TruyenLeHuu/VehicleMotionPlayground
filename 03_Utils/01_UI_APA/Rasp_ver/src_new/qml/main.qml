...
Window {
    id: mainWindow
    width: 1250*mainWindow.scale
    height: 0.55*1200*mainWindow.scale
    minimumWidth: 600
    minimumHeight: 400
    visible: true
    color: "#00000000"
    ...
    property int is_big_screen: 1
    property int is_small_screen: 0
    property double scale: 0.5 * is_small_screen + 1.5 * is_big_screen
    property double gauge_scale: 0.5 * is_small_screen + 1.1 * is_big_screen
    property double car_scale: 0.5 * is_small_screen + 1 * is_big_screen
