...
class World(object):
    def __init__(self, carla_world, hud, actor_filter, _player):
...
class HUD(object):
    ...
    def tick(self, world, clock, player):
        ...
        self._info_text = [
            ...
            u'Heading vertical:% 10.0f\N{DEGREE SIGN}' % (t.rotation.pitch),
...
class DualControl(object):
    def __init__(self, parent):
        ...
        if (self.is_connect_with_VM):
            ...
            self._parser.read('/home/loi/03_VMEnv/03_framework/client_side/wheel_config.ini')
            self._steer_idx = int(
    ...
    def parse_events(self, world, clock, player):
