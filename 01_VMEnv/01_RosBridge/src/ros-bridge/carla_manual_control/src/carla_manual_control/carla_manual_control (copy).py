...
class KeyboardControl(object):
        ...
        for x in int_data:
            ...
            if(x[0] < 6.5 and x[0] > 0.5 and x[1] < 0.7 and x[1]> -0.7 and x[2] < 1 and x[2]> -1.3):
                ...
                if self._control.reverse == False:
                    ...
                    self.node.logwarn("xxxxxxxxxxxxxxx--------------------------------:: {}".format(x[1]))
                    self.node.logwarn("xxxxxxxxxxxxxxx--------------------------------: {}".format(x[2]))
    ...
    def _parse_vehicle_keys(self, keys, milliseconds):
        ...
        if (keys[K_DOWN] or keys[K_s]) & (self.AEB_activated and self._control.reverse == False):
