...
echo_and_run cd "/home/loi/Vehicle_Motion_Playground/03_VMEnv/02_ros-bridge/src/ros-bridge/carla_spawn_objects"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/loi/Vehicle_Motion_Playground/03_VMEnv/02_ros-bridge/src/ros-bridge/carla_spawn_objects/setup.py" \
     \
    build --build-base "/home/loi/Vehicle_Motion_Playground/03_VMEnv/02_ros-bridge/build/ros-bridge/carla_spawn_objects" \
    install \
    --root="${DESTDIR-/}" \
