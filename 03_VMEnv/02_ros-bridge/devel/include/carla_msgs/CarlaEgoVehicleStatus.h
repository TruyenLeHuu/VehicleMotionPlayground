...
#include <carla_msgs/CarlaEgoVehicleRotation.h>
...
struct CarlaEgoVehicleStatus_
{
  ...
  _location_type location;
   ...
   typedef  ::carla_msgs::CarlaEgoVehicleRotation_<ContainerAllocator>  _rotation_type;
...
struct MD5Sum< ::carla_msgs::CarlaEgoVehicleStatus_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x2fd2506e0dd6f309ULL;
  static const uint64_t static_value2 = 0x27082499511f5596ULL;
};
...
struct Printer< ::carla_msgs::CarlaEgoVehicleStatus_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::carla_msgs::CarlaEgoVehicleStatus_<ContainerAllocator>& v)
  {
    ...
    s << indent << "rotation: ";
    s << std::endl;
    Printer< ::carla_msgs::CarlaEgoVehicleRotation_<ContainerAllocator> >::stream(s, indent + "  ", v.rotation);
    s << indent << "control: ";
    s << std::endl;
