...
let CarlaEgoVehicleRotation = require('./CarlaEgoVehicleRotation.js');
...
class CarlaEgoVehicleStatus {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('rotation')) {
        ...
        this.rotation = new CarlaEgoVehicleRotation();
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = CarlaEgoVehicleRotation.serialize(obj.rotation, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.rotation = CarlaEgoVehicleRotation.deserialize(buffer, bufferOffset);
  ...
  static md5sum() {
    ...
    return '2fd2506e0dd6f30927082499511f5596';
  }
  ...
  static messageDefinition() {
    ...
    CarlaEgoVehicleRotation rotation
    ...
    ================================================================================
    MSG: carla_msgs/CarlaEgoVehicleRotation
    float32 roll
    float32 pitch
    float32 yaw
    ================================================================================
  ...
  static Resolve(msg) {
    ...
    if (msg.rotation !== undefined) {
      resolved.rotation = CarlaEgoVehicleRotation.Resolve(msg.rotation)
    }
    else {
      resolved.rotation = new CarlaEgoVehicleRotation()
    }
